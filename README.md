...
Visit the live application: [Grand Horizon Hotel](https://hotel-frontend-dun.vercel.app/)
...
The backend repository is available at: [Hotel Backend](https://github.com/ShawnAjamala/final_capstone)
