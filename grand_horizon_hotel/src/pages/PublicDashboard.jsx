    ...
    <div className="min-h-screen bg-stone-50 font-sans">
      ...
      <section className="max-w-6xl mx-auto py-24 px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
          {[
            { icon: BedDouble, title: 'Rooms', desc: 'Book your perfect stay' },
            { icon: UtensilsCrossed, title: 'Restaurant', desc: 'Fine dining experience' },
            { icon: Presentation, title: 'Conference', desc: 'Modern meeting spaces' },
            { icon: PartyPopper, title: 'Events', desc: 'Weddings & celebrations' },
          ].map((service, i) => (
            <div key={i} onClick={() => navigate('/login')} className="bg-white border border-stone-200 rounded-2xl p-8 text-center cursor-pointer hover:border-amber-400 hover:shadow-lg transition-all duration-300">
